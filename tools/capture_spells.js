// Walk the game's F3 spell list and screenshot every spell's detail screen.
//
// Same approach as capture_monsters.js: the game's own clue book is the oracle
// for what each field in the 80-byte spell record means.
//
//   YENDOR_GAME_DIR=tmp/game-patched bun tools/capture_spells.js \
//       --out=tmp/spells --count=107
...
const outDir = arg("out", "tmp/spells");
const count = Number(arg("count", 107));
