...
Everything here is **code**, read off the disassembly rather than off the running game. [README.md](README.md) defines the classifiers. Three independent corroborations are at the end.
